...
mixin _$SignUpStore on _SignUpStore, Store {
  ...
  bool get phoneValid =>
      (_$phoneValidComputed ??= Computed<bool>(() => super.phoneValid,
          ...
          .value;
  Computed<bool> _$ruaValidComputed;

  @override
  bool get ruaValid => (_$ruaValidComputed ??=
          Computed<bool>(() => super.ruaValid, name: '_SignUpStore.ruaValid'))
      .value;
  ...
  final _$ruaAtom = Atom(name: '_SignUpStore.rua');
  ...
  final _$numeroAtom = Atom(name: '_SignUpStore.numero');
  ...
  void setRua(String value) {
    final _$actionInfo =
        _$_SignUpStoreActionController.startAction(name: '_SignUpStore.setRua');
    try {
